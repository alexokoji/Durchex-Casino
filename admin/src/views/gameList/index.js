                            ...
                            gameList?.map((item, index) => (
                                <TableRow key={item._id} className={classes.TableRow}>
                                    ...
                                    <TableCell>
                                        {
                                            (() => {
                                                const href = item.gameLink && item.gameLink.length > 0 && !item.gameLink.startsWith('/') ?
                                                    (item.gameLink.startsWith('http') ? item.gameLink : `/app/games/${item.gameLink}`)
                                                    : `/app/games/${item.gameLink || (item.gameName || '').toLowerCase()}`;
                                                return (
